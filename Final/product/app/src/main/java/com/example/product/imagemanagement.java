...
// This code was not created by Aminur but it has been modified by Aminur       source: https://codinginflow.com/tutorials/android/firebase-storage-upload-and-retrieve-images/part-1-preparations-upload-layout
...
public class imagemanagement extends AppCompatActivity {
    ...
    private Uri imageuri; // this is the uri that will point to the image
